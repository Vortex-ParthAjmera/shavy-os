# SHAVY OS - Intelligence Core Daemon v0.1
# The always-on D-Bus service every other piece of SHAVY calls into.
# This is the "engine" - ai_shell.py and brief.py will be refactored next
# to call this instead of talking to Ollama directly, so there's one shared
# brain instead of every script reinventing the same Ollama calls.
...
class ShavyCore:
    ...
    Query() on this over the session bus - that's the whole point.
    """
